...
local pokemonData = {
  ...
  ability = {
		...
		"Effect Spore", "Synchronize", "Clear Body", "Natural Cure", "Lightning Rod",
		"Serene Grace", "Swift Swim", "Chlorophyll", "Illuminate", "Trace",
		"Huge Power", "Poison Point", "Inner Focus", "Magma Armor", "Water Veil",
		...
		"Vital Spirit", "White Smoke", "Pure Power", "Shell Armor", "Air Lock"
	},
	type = {
